  ...
  <div class="container">
    <div class="inner-affordable d-flex gap-lg-4">
      <div class="affordable-left">
        <h3 class="heading fs3-75 fw-semibold">Affordable excellence in UX designs for startups</h3>
...
<section class="empower-section ">
  <div class="container">
    <div class="empower-left-box d-flex flex-column justify-content-center text-center gap-lg-3 ">
      <h3 class="heading fs3-75">Empower your startup with user centric design</h3>
      <p class="para fs1-5">
